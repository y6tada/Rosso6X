...
LD_FLAGS = $(CPU) -Wl,--gc-sections -Wl,--wrap,main -Wl,--wrap,_malloc_r -Wl,--wrap,_free_r -Wl,--wrap,_realloc_r
...
ifeq ($(USE_LIBMBED), 1)
	...
	INCLUDE_PATHS += -I"$(HOME)/Library/Developer/Xcode/Templates/embedded/mbed" -I"$(HOME)/Library/Developer/Xcode/Templates/embedded/mbed/TARGET" -I$(LIBMBED) -I$(LIBMBED)/TARGET_NUCLEO_F446RE
